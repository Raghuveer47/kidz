...
/**
 * Class 4 — WHAT IS AI sub-lessons: purple palette, back link to hub.
 */
export default function WhatIsAiLesson({ content, classId, showBackLink = true }) {
    ...
    return (
        <div className="space-y-10 font-nunito">
            ...
            <section className="relative overflow-hidden rounded-3xl border-2 border-purple-400 bg-gradient-to-br from-purple-50 via-violet-50 to-indigo-50 p-6 shadow-[0_12px_28px_-16px_rgba(124,58,237,0.28)] md:p-8">
                <div className="pointer-events-none absolute -right-8 top-0 h-28 w-28 rounded-full bg-violet-200/40 blur-2xl" />
                <div className="relative">
                    <div className="mb-3 inline-flex items-center gap-2 rounded-full border-2 border-purple-400 bg-white/90 px-3 py-1 text-xs font-extrabold uppercase tracking-wide text-purple-900">
                ...
                <div className="space-y-6">
                    {sections.map((section, idx) => (
                        <div
                            ...
                            className="overflow-hidden rounded-2xl border-2 border-purple-400 shadow-[0_10px_24px_-12px_rgba(15,23,42,0.2)]"
                        >
                            <div className="flex flex-wrap items-center gap-2 bg-gradient-to-r from-purple-600 to-violet-700 px-4 py-3 text-white">
                            ...
                            <div className="bg-white">
                                {section.image ? (
                                    <ImageBesideSection
                                        ...
                                        pointMarkerClass="text-purple-600"
