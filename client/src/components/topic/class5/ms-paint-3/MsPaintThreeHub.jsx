...
/** Class 5 — MS PAINT-3 hub: image editing, exercises, certification CTA. */
export default function MsPaintThreeHub({ content, classId }) {
    const paintDetail = content.paintDetail || {};
    const hubHeroImage = content.hubHeroImage;
    const heroTitle = content.msPaintSmartBasicsTitle || 'MS Paint-3 — Images & Mastery';
            ...
            <div className="grid gap-3 sm:grid-cols-2">
                <div className="rounded-2xl border border-fuchsia-300 bg-white/90 p-3 shadow-sm">
                    <p className="text-justify text-sm font-bold text-fuchsia-900">
                        <strong>Working with images</strong>—open photos, crop, rotate, flip, and combine pictures in Paint.
                    </p>
                </div>
                <div className="rounded-2xl border border-violet-300 bg-white/90 p-3 shadow-sm">
                    <p className="text-justify text-sm font-bold text-slate-800">
                        <strong>Exercises &amp; certification</strong>—practice projects, then earn your Paint-3 certificate.
                    </p>
                </div>
            </div>
        ...
        <div className="space-y-10 font-nunito">
            <section className="relative overflow-hidden rounded-3xl border-2 border-fuchsia-400 bg-gradient-to-br from-fuchsia-50 via-violet-50 to-rose-50 p-6 shadow-[0_12px_28px_-16px_rgba(192,38,211,0.32)] md:p-8">
                ...
                <div className="relative">
                    ...
                    {hubHeroImage ? (
                        <ImageBesideSection
                            section={{ image: hubHeroImage, subtitle: heroTitle, body: paintDetail.intro }}
                            textPosition="below"
            ...
            {(content.sections || []).length > 0 ? (
                <section>
                    <h2 className="mb-4 text-xl font-extrabold text-slate-900 md:text-2xl">Paint-3 skills (preview)</h2>
            ...
            <section className="grid gap-6 md:grid-cols-2">
                <div className="rounded-2xl border-2 border-fuchsia-300 bg-fuchsia-50/70 p-6">
                    <h2 className="text-lg font-extrabold text-fuchsia-950 md:text-xl">Why we study Paint-3</h2>
            ...
            <section className="rounded-2xl border-2 border-fuchsia-400 bg-white p-1 shadow-md">
                <Link
                    to={`/class${classId}/ms-paint-3-image.html`}
                ...
                <p className="px-4 pb-4 pt-3 text-justify text-sm text-slate-600 md:px-5">
                    Opens the first lesson. Use the sidebar under <strong className="text-slate-800">MS PAINT-3</strong> for
