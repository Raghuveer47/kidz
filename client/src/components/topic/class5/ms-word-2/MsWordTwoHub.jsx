...
/** Class 5 — MS WORD-2 hub: Insert tab focus, preview sections, lesson CTA. */
export default function MsWordTwoHub({ content, classId }) {
    const wordDetail = content.wordDetail || {};
    const hubHeroImage = content.hubHeroImage;
    const heroTitle = content.msWordSmartBasicsTitle || 'MS Word-2 — Insert & Layout';
            ...
            <div className="grid gap-3 sm:grid-cols-2">
                <div className="rounded-2xl border border-blue-300 bg-white/90 p-3 shadow-sm">
                    <p className="text-justify text-sm font-bold text-blue-900">
                        <strong>Insert tab</strong>—add tables, pictures, shapes, headers, WordArt, symbols, and page numbers.
                    </p>
                </div>
                <div className="rounded-2xl border border-indigo-300 bg-white/90 p-3 shadow-sm">
                    <p className="text-justify text-sm font-bold text-slate-800">
                        <strong>Build on Word-1</strong>—you already know Home and File; now make documents look like real projects.
                    </p>
                </div>
            </div>
        ...
        <div className="space-y-10 font-nunito">
            <section className="relative overflow-hidden rounded-3xl border-2 border-blue-400 bg-gradient-to-br from-blue-50 via-indigo-50 to-sky-50 p-6 shadow-[0_12px_28px_-16px_rgba(37,99,235,0.28)] md:p-8">
                ...
                <div className="relative">
                    ...
                    {hubHeroImage ? (
                        <ImageBesideSection
                            section={{ image: hubHeroImage, subtitle: heroTitle, body: wordDetail.intro }}
                            textPosition="below"
            ...
            {(content.sections || []).length > 0 ? (
                <section>
                    <h2 className="mb-4 text-xl font-extrabold text-slate-900 md:text-2xl">Insert skills (preview)</h2>
            ...
            <section className="grid gap-6 md:grid-cols-2">
                <div className="rounded-2xl border-2 border-blue-300 bg-blue-50/70 p-6">
                    <h2 className="text-lg font-extrabold text-blue-950 md:text-xl">Why we study Word-2</h2>
            ...
            <section className="rounded-2xl border-2 border-blue-400 bg-white p-1 shadow-md">
                <Link
                    to={`/class${classId}/ms-word-2-insert-menu.html`}
                ...
                >
                    <span className="font-nunito text-base font-extrabold md:text-lg">
                        Start with Working with Insert Menu options →
                    </span>
                ...
                <p className="px-4 pb-4 pt-3 text-justify text-sm text-slate-600 md:px-5">
                    Opens the first lesson. Use the sidebar under <strong className="text-slate-800">MS WORD-2</strong> for all
                    eight sub-lessons anytime.
                </p>
            </section>
        </div>
    );
