...
/** Class 5 — MS Word-2 sub-lessons: blue/indigo palette, back link to hub. */
export default function MsWordTwoLesson({ content, classId, showBackLink = true }) {
        ...
        <div className="space-y-10 font-nunito">
            {showBackLink ? (
                <div className="rounded-2xl border-2 border-blue-300 bg-gradient-to-r from-blue-50 to-indigo-50 p-4 shadow-sm">
                    <Link
                        to={`/class${classId}/ms-word-2.html`}
