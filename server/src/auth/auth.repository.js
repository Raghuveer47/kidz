...
class AuthRepository {
  ...
  static async updateUser(userId, updateData) {
    try {
      ...
      if (updateData.classLevel !== undefined) updateQuery.classLevel = updateData.classLevel;
      if (updateData.parentId !== undefined) updateQuery.parentId = updateData.parentId;
